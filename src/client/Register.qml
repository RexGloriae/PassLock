...
Item {
    ...
    RegisterManager{
        ...
        onRegisterResult: {
            if(res ===1) {
                notify.show("You have registered!");
                usernameField.text = ""
                passwordField.text = ""
    ...
    Column {
        ...
        Image {
            ...
            anchors.topMargin: 35 // Adds a margin between the text and the image
            z: 1
        }
    ...
    Rectangle {
        ...
        Column {
            ...
            Row {
                anchors.horizontalCenter: parent.horizontalCenter
                spacing: 20
                anchors.topMargin: 20  // Adjust spacing from input fields
                ...
                Button {
                    ...
                    onClicked: {
                        if(usernameField.text === "") {
                            ...
                            notify.show("Username must be at least 8\ncharacters long.");
                        }
                        else if (is_alphnum(usernameField.text) === false) {
                            notify.show("Username must be alpha-numerical.");
                        }
                        else if (is_alphnum_special(passwordField.text) === false) {
                            ...
                            notify.show("Email field is empty!");
                        }
                            ...
                            registerManager.reg(usernameField.text, passwordField.text, emailField.text);
                        }
                    }
                }
